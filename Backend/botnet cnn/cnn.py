...
class CnnPredictor(object):
    ...
    def get_config_file_path(model_dir_path):
        return model_dir_path + '/' + CnnPredictor.model_name + '-config.npy'

    @staticmethod
    def get_weight_file_path(model_dir_path):
        return model_dir_path + '/' + CnnPredictor.model_name + '-weights.h5'

    @staticmethod
    def get_architecture_file_path(model_dir_path):
        return model_dir_path + '/' + CnnPredictor.model_name + '-architecture.json'
